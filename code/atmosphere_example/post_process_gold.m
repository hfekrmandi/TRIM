function [error_results] =post_process_gold()
global opt_dist
...
function error_struct = calc_error_stat(method)
global opt_dist
...
error_struct.mean.e_cen = mean( error_struct.e_cen(:));
error_struct.mean.con_perc_cen  = mean( error_struct.con_perc_cen(:) );

%% Error Gold vs. Ground Truth
error_struct.mean.e_gold = mean(  error_struct.e_gold(:) );

%% Error Gold vs. centralized
error_struct.mean.e_gold_vs_cent = mean(  error_struct.e_gold_vs_cent(:) );

%% Error vs. centralized
error_struct.mean.e_vs_cen = mean( error_struct.e_vs_cen(:) );

%% Error vs. gold
error_struct.mean.e_vs_gold = mean(  error_struct.e_vs_gold(:) );

%% Error vs. Ground Truth
error_struct.mean.e_vs_gt = mean( error_struct.e_vs_gt(:) );

%% consistency
error_struct.mean.con_perc  = mean( error_struct.con_perc(:) );

%% root of det criteria
error_struct.mean.e_root_ratio_cent = mean( error_struct.e_root_ratio_cent(:) );
error_struct.mean.e_root_ratio_gold = mean( error_struct.e_root_ratio_gold(:) );

%% root of det values
error_struct.mean.e_cent_root = mean( error_struct.e_cent_root(:) );
error_struct.mean.e_gold_root = mean( error_struct.e_gold_root(:) );
error_struct.mean.e_root = mean( error_struct.e_root(:) );

%% trace criteria
error_struct.mean.e_trace_ratio_cent = mean( error_struct.e_trace_ratio_cent(:) );
error_struct.mean.e_trace_ratio_gold = mean( error_struct.e_trace_ratio_gold(:) );

%% trace values
error_struct.mean.e_trace_cen = mean( error_struct.e_trace_cen(:) );
error_struct.mean.e_trace_gold = mean( error_struct.e_trace_gold(:) );
error_struct.mean.e_trace = mean( error_struct.e_trace(:) );

%% Bhattacharya Distance
error_struct.mean.e_BC_dist_gold = mean( error_struct.e_BC_dist_gold(:) );
error_struct.mean.e_BC_dist_cent = mean( error_struct.e_BC_dist_cent(:) );
error_struct.mean.e_BC_dist_gold_vs_cent = mean( error_struct.e_BC_dist_gold_vs_cent(:) );
