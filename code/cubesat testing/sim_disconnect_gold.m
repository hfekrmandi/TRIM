...
switch opt_dist.scenario
    case '1'
    % Disconnect the system for these steps
...
%             (opt_dist.i_step > 22 && opt_dist.i_step<30);
   ...
   disconnection_interval = (opt_dist.i_step >= 2 && opt_dist.i_step <= 3) ||...
            (opt_dist.i_step >= 6 && opt_dist.i_step <= 7)||...
            (opt_dist.i_step > 16 && opt_dist.i_step<20)||...
            (opt_dist.i_step > 22 && opt_dist.i_step<30);
    ...
    case '2'
    % This is where we put if(agent distance > n), disconnect (in G)
